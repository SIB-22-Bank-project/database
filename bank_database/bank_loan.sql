...
CREATE TABLE `loan` (
  ...
  `time_period_months` int(11) NOT NULL,
  `iterest_perc_per_annum` int(1) NOT NULL,
  `amt-per-month` int(11) NOT NULL,
  `remaining_amt` int(11) NOT NULL,
  PRIMARY KEY (`acc_no`),
  CONSTRAINT `loan_ibfk_1` FOREIGN KEY (`acc_no`) REFERENCES `clients` (`acc_no`)
